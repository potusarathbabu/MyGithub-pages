...
<head>
<meta charset="utf-8">
<title>SuperMarket edit Peoduct</title>
...
<style>
body {
    background-image: url("resources/images/AddProduct.jpeg");
...
<body background="<c:url value="resources\images\bags.jpg"/>" onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
...
<center><a class="btn btn-success" href="Signin" target="_parent" style="float: right;"><span class="glyphicon glyphicon-log-out">Logout</span></a></center>
<ul><b>
