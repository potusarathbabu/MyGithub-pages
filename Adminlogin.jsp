...
width:100%;
height:100%;
background:url('E:\ecommerce.png')center center no-repeat;
}
</style>-->
...
<body background="<c:url value="resources\images\gb1.png"/>" onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
<div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <span class="sr-only">Manage Product</span>
		            ...
		            <div class="row">
			            <div class="col-sm-4">
				            <ul class="multi-column-dropdown">
					            ...
					            <li><a href="AddProduct" target="_self">Remove</a></li>
					            <li><a href="AddProduct" target="_self">Update</a></li>
					            <!--  <li><a href="#">Search</a></li>-->
					            <li><a href="AddProduct" target="_self">View all</a></li>
				            </ul>
			            </div>
			            <div class="col-sm-4">
				            <ul class="multi-column-dropdown">
			            ...
			            <div class="col-sm-4">
				            <ul class="multi-column-dropdown">
					            <li><b>Suppliers</b></li>
					            <li class="divider"></li>
					            <li><a href="supplier" target="_self">Add</a></li>
					            <li><a href="supplier" target="_self">Remove</a></li>
					            <li><a href="supplier" target="_self">Update</a></li>
					            <!--  <li><a href="#">Search</a></li>-->
					            <li><a href="supplier" target="_self">View all</a></li>
				            </ul>
			            </div>
		            </div>
	            </ul>
...
<b><center><font face="Comic Sans MS"><h1>Welcome Adminlogin</h1></font></center></b>
