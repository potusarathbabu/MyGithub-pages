...
<body>
	...
	<form:form method="POST" commandName="blog" action="bpost">
		<table>
			...
			<tr>
				<td><form:input path="title" width="50" /></td>
			</tr>
			<tr>
				<td>Content :</td>
			</tr>
			<tr>
				<td><form:textarea path="content" rows="10" cols="150" /></td>
			</tr>
			<tr>
	...
	<%@include file="BlogAngularjs.jsp"%>
...
<table>
    ...
    <td>Title :</td></tr>
    <tr><td>
    <form:input path="title" width="50" /></td>
    </tr>
    <tr>
        <td>Content :</td></tr>
   ...
   <thead>
    ...
    <tbody>
      ...
      <tr ng-repeat="b in Blogs | orderBy:sortType:sortReverse | filter:searchBlogTitle">
        ...
        <td>{{ b.title}}</td>
        <td>{{ b.content }}...<a href="getFullBlogInfoReq?id={{b.BlogID}}">Read Complete</a></td>
        <td>{{ b.username}}</td>
