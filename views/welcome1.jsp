...
<body><br><br>
<center><h1 style="color:red">PLEASE SIGN UP OR SIGN IN THEN VISIT US</h1></center>
<br><br><br>
<div class="container">
     
     <div class="col-md-14">
      <a href="Signin" class="thumbnail">
        <img src="resources/images/welcome3.gif" alt="literature"  style="width:1000px;height:150px">
<center><h1><p class="center large">SUPER MARKET</p></center></h1>
      </a>
    </div>
    <div class="row">
    <div class="col-md-4">
      <a href="Signin" class="thumbnail">
        <img src="resources/images/all2.jpg" alt="literature"  style="width:300px;height:120px">
<center><p><h3>FRUITS</h3></p></center>
      </a>
    </div>
