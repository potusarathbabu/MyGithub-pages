...
<tr>
<td>
<h2 style=color:white">Enter User Name:</td> <td><input type="text"name="username"></td></tr>
<tr>
<td>
<h2 style=color:white">Enter Password:</td> <td><input type="password"name="password"></td></tr>
</table>
