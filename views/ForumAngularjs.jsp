    ...
    <thead>
      ...
      <td>
          <a href="#" ng-click="sortType = 'postid'; sortReverse = !sortReverse">
            Post Id 
            <span ng-show="sortType == 'postid' && !sortReverse" class="fa fa-caret-down"></span>
            <span ng-show="sortType == 'postid' && sortReverse" class="fa fa-caret-up"></span>
          </a>
        </td>
        
        <td>
          <a href="#" ng-click="sortType = 'posttitle'; sortReverse = !sortReverse">
           Forum Title 
        ...
        <td>
          <a href="#" ng-click="sortType = 'postcontent'; sortReverse = !sortReverse">
          Content 
            <span ng-show="sortType == 'postcontent' && !sortReverse" class="fa fa-caret-down"></span>
            <span ng-show="sortType == 'postcontent' && sortReverse" class="fa fa-caret-up"></span>
          </a>
        </td>
        <td>
